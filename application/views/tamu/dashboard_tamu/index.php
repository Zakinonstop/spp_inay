                            ...
                            foreach ($data_santri as $ds) {
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td style="padding: 5px;" width="50">
                                        <a type="button" class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Lihat Transaksi" href="<?= base_url('dashboard_tamu/view/') ?><?= $ds->id ?>">Lihat</a>
                                    </td>
                                    <!-- <td width="50">
                                        <a class="text-primary" data-toggle="tooltip" data-placement="top" title="Detail" href="<?= base_url('dashboard_tamu/detail/') ?><?= $ds->id ?>"><i class="fa fa-eye"></i></a>
                                    </td> -->
                                </tr>
                            <?php } ?>
                        </tbody>
