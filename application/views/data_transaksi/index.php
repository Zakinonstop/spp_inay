            ...
            <div class="row d-flex">
                ...
                <div class="col-6">
                    ...
                    <div class="dataTables_length float-right" id="example1_length">
                        <a href="<?= base_url('data_transaksi/add') ?>" type="button" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Tambah Data">Tambah Data</a>
                    </div>
                </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Kelas: activate to sort column ascending">Tanggal Bayar</th>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                        ...
                                        if ($ds->jumlah_bayar) {
                                            ...
                                            <?php $urut++; ?>
                                            <a type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Input Transaksi" href="<?= base_url('data_transaksi/add/') ?><?= $ds->id_data_transaksi ?>">Input Transaksi</a>
                                        <?php } else { ?>
                                            <a type="button" aria-disabled="true" class="btn btn-sm btn-primary disabled" data-toggle="tooltip" data-placement="top" title="Input Transaksi" href="<?= base_url('data_transaksi/add/') ?><?= $ds->id_data_transaksi ?>">Input Transaksi</a>
                                        <?php } ?>
                                    ...
                                    <td>
                                        <?php if ($ds->sisa > 0) { ?>
                                            ...
                                            <a type="button" class="btn btn-sm btn-primary" onclick="confirm('Uang sisa digunakan untuk spp bulan selanjutnya ?')" data-toggle="tooltip" data-placement="top" title="Untuk bulan Selanjutnya" href="<?= base_url('data_transaksi/next/') ?><?= $ds->id_data_transaksi ?>">next</a>
                                            <a type="button" class="btn btn-sm btn-primary" onclick="confirm('Untuk Kembalian ?')" data-toggle="tooltip" data-placement="top" title="Untuk bulan Selanjutnya" href="<?= base_url('data_transaksi/kembalian/') ?><?= $ds->id_data_transaksi ?>">Kembalian</a>
                                        <?php } else if ($ds->sisa < 0) { ?>
                                            <?php $urut--; ?>
                                            <p><?= $ds->sisa; ?> | <a type="button" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="Update Transaksi" href="<?= base_url('data_transaksi/edit/') ?><?= $ds->id_data_transaksi ?>">update transaksi</a></p>
                                        <?php } else { ?>
                                            <?= $ds->sisa; ?>
                                        <?php } ?>
                                    ...
                                    <td width="50">
                                        <a class="text-primary" data-toggle="tooltip" data-placement="top" title="Detail" href="<?= base_url('data_transaksi/detail/') ?><?= $ds->id_data_transaksi ?>"><i class="fa fa-eye"></i></a>
                                    </td>
                                    <td width="50">
                                        <a class="text-primary" data-toggle="tooltip" data-placement="top" title="Edit" href="<?= base_url('data_transaksi/edit/') ?><?= $ds->id_data_transaksi ?>"><i class="fa fa-edit"></i></a>
                                    </td>
                                    <!-- <td width="50">
                                        <a onclick="confirm('Anda Yakin ?')" class="text-danger" data-toggle="tooltip" data-placement="top" title="Hapus" href="<?= base_url('data_transaksi/hapus/') ?><?= $ds->id_data_transaksi ?>"><i class="fa fa-trash"></i></a>
                                    </td> -->
                                </tr>
                            <?php
                            } ?>
