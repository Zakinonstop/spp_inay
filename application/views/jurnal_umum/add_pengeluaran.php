<div class="card card-success">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form role="form" action="<?= base_url('jurnal_umum/add_save_pengeluaran') ?>" method="POST">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="pengeluaran" placeholder="Nominal Pengeluaran">
            </div>
